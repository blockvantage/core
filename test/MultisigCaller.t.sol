...
contract MultisigCallerTest is Test {
    ...
    function testConstructor_RevertTooManyApprovals() public {
        ...
        vm.expectRevert(
            abi.encodeWithSignature("RequiredApprovalsExceedApprovers(uint256,uint256)", MAX_APPROVERS + 1, 2)
        );
    ...
    function testConstructor_RevertTooFewApprovals() public {
        ...
        vm.expectRevert(
            abi.encodeWithSignature("RequiredApprovalsTooLow(uint256,uint256)", MIN_APPROVERS - 1, MIN_APPROVERS)
        );
    ...
    function testSubmitTransaction_RevertNonApprover() public {
        ...
        vm.expectRevert(
            abi.encodeWithSignature("AccessControlUnauthorizedAccount(address,bytes32)", nonApprover, APPROVER_ROLE)
        );
    ...
    function testApproverManagement_ShouldAllowAddingNewApprover() public {
        ...
        bytes memory addApproverData =
            abi.encodeWithSelector(MultisigCaller.grantRole.selector, APPROVER_ROLE, nonApprover);
    ...
    function testApproverManagement_ShouldNotExceedMaxApprovers() public {
        ...
        for (uint256 i = 0; i < 7; i++) {
            ...
            bytes memory addApproverData =
                abi.encodeWithSelector(MultisigCaller.grantRole.selector, APPROVER_ROLE, newApprover);
        ...
        bytes memory lastApproverData =
            abi.encodeWithSelector(MultisigCaller.grantRole.selector, APPROVER_ROLE, lastApprover);
    ...
    function testApproverManagement_ShouldNotAllowRemovingIfInsufficientApprovers() public {
        ...
        bytes memory removeApproverData =
            abi.encodeWithSelector(MultisigCaller.revokeRole.selector, APPROVER_ROLE, approver2);
        ...
        bytes memory removeAnotherApproverData =
            abi.encodeWithSelector(MultisigCaller.revokeRole.selector, APPROVER_ROLE, approver3);
    ...
    function testApproverManagement_ShouldNotAllowNonAdminToAddApprover() public {
        ...
        vm.prank(approver1);
        vm.expectRevert(
            abi.encodeWithSignature("AccessControlUnauthorizedAccount(address,bytes32)", approver1, DEFAULT_ADMIN_ROLE)
        );
    ...
    function testRequiredApprovalsManagement_ShouldAllowChangingRequiredApprovals() public {
        bytes memory changeApprovalsData = abi.encodeWithSelector(MultisigCaller.setRequiredApprovals.selector, 3);
        vm.prank(approver1);
    ...
    function testRequiredApprovalsManagement_ShouldNotAllowBelowMinimum() public {
        bytes memory changeApprovalsData = abi.encodeWithSelector(MultisigCaller.setRequiredApprovals.selector, 1);
    ...
    function testRequiredApprovalsManagement_ShouldNotAllowAboveApproverCount() public {
        bytes memory changeApprovalsData = abi.encodeWithSelector(MultisigCaller.setRequiredApprovals.selector, 4);
        ...
        for (uint256 i = 0; i < approvers.length; i++) {
            ...
            vm.expectRevert(
                abi.encodeWithSignature(
                    "AccessControlUnauthorizedAccount(address,bytes32)", approvers[i], DEFAULT_ADMIN_ROLE
                )
            );
    ...
    function testFuzz_RequiredApprovals(uint256 newRequiredApprovals) public {
        ...
        bytes memory changeApprovalsData =
            abi.encodeWithSelector(MultisigCaller.setRequiredApprovals.selector, newRequiredApprovals);
        ...
        if (newRequiredApprovals < 2) {
            vm.expectRevert(
                abi.encodeWithSignature("RequiredApprovalsTooLow(uint256,uint256)", newRequiredApprovals, 2)
            );
        } else {
            vm.expectRevert(
                abi.encodeWithSignature("RequiredApprovalsExceedApprovers(uint256,uint256)", newRequiredApprovals, 3)
            );
        }
    ...
    function testReentrancy_ShouldPreventInSubmitTransaction() public {
        ...
        bytes memory addApproverData =
            abi.encodeWithSelector(MultisigCaller.grantRole.selector, APPROVER_ROLE, address(attacker));
        vm.prank(approver1);
        multisigCaller.submitTransaction(address(multisigCaller), 0, addApproverData);
        vm.prank(approver2);
        multisigCaller.approveTransaction(0);
    ...
    function testReentrancy_ShouldPreventInApproveTransaction() public {
        ...
        bytes memory approveData = abi.encodeWithSelector(MultisigCaller.approveTransaction.selector, 1);
        vm.prank(approver1);
    ...
    function testOwnable_ShouldTransferOwnershipThroughMultisig() public {
        ...
        bytes memory transferData = abi.encodeWithSelector(Ownable.transferOwnership.selector, nonApprover);
        vm.prank(approver1);
        ...
        bytes memory restrictedData = abi.encodeWithSelector(OwnableTest.restrictedFunction.selector);
        vm.prank(approver1);
    ...
    function testERC20_ShouldTransferTokensAfterRequiredApprovals() public {
        ...
        assertEq(
            token.balanceOf(address(multisigCaller)), multisigBalanceBefore - amount, "Multisig balance should decrease"
        );
    ...
    function testERC20_ShouldFailIfTransferringMoreThanBalance() public {
        ...
        bytes memory transferData = abi.encodeWithSelector(IERC20.transfer.selector, recipient, tooMuch);
        ...
        vm.expectRevert(
            abi.encodeWithSignature(
                "ERC20InsufficientBalance(address,uint256,uint256)", address(multisigCaller), balance, tooMuch
            )
        );
        multisigCaller.approveTransaction(0);
    }
    ...
    function testMulticall_ShouldAllowContractToSpendFundsInSingleTransaction() public {
        ...
        calls[1] = MultisigCaller.Call3({
            ...
            callData: abi.encodeWithSelector(
                DummyContract.callTransferFrom.selector, address(token), address(multisigCaller), address(dummy), 100
            )
        });

        bytes memory multicallData = abi.encodeWithSelector(MultisigCaller.aggregate3.selector, calls);
        ...
        assertEq(
            token.balanceOf(address(multisigCaller)), multisigBalanceBefore - 100, "Multisig balance should decrease"
        );
    ...
    function testMulticall_ShouldHandleFailedCallsWhenAllowFailureIsTrue() public {
        ...
        calls[0] =
            MultisigCaller.Call3Value({target: address(dummy), allowFailure: true, value: 0, callData: hex"1234"});

        // Second call: send ETH
        calls[1] = MultisigCaller.Call3Value({target: address(dummy), allowFailure: false, value: amount, callData: ""});

        bytes memory multicallData = abi.encodeWithSelector(MultisigCaller.aggregate3Value.selector, calls);
    ...
    function testMulticall_ShouldRevertIfCallFailsAndAllowFailureIsFalse() public {
        ...
        calls[0] = MultisigCaller.Call3({target: address(dummy), allowFailure: false, callData: hex"1234"});

        // Second call: would succeed but won't execute
        calls[1] = MultisigCaller.Call3({target: address(dummy), allowFailure: true, callData: hex"1234"});
    ...
    function testMulticall_ShouldHandleValueTransfersCorrectly() public {
        ...
        calls[0] = MultisigCaller.Call3Value({target: address(dummy), allowFailure: false, value: amount, callData: ""});
    ...
    function testMulticall_ShouldPreventNonAdminFromCallingAggregate3Directly() public {
        ...
        calls[0] = MultisigCaller.Call3({target: address(dummy), allowFailure: false, callData: ""});
